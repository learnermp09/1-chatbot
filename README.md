...
ThinkChain is an AI-powered conversational assistant built using **LangChain**, **Groq**, and **Streamlit**. The application enables users to interact with a large language model **qwen/qwen3-32b** through a simple and intuitive web interface.
